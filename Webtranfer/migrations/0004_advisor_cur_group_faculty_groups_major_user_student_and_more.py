# Generated by Django 4.1.5 on 2023-03-28 16:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Webtranfer', '0003_remove_groups_fac_name_remove_groups_mj_name_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Faculty',
            fields=[
                ('Fac_ID', models.IntegerField(primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Groups',
            fields=[
                ('G_ID', models.IntegerField(primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Major',
            fields=[
                ('Mj_ID', models.IntegerField(primary_key=True, serialize=False, unique=True)),
